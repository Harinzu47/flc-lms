<nav class="fixed top-0 w-full z-50 glass-header shadow-sm" aria-label="Top navigation">
    <div class="flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto">
        ...
        <div class="flex items-center gap-3" x-data="{ userMenuOpen: false }">
            <div class="relative">
                <button @click="userMenuOpen = !userMenuOpen" @keydown.escape.window="userMenuOpen = false"
                    ...
                    <div
                        class="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-primary-container flex items-center justify-center text-on-primary font-bold text-xs border-2 border-primary/10">
                ...
                <div x-show="userMenuOpen" x-cloak @click.away="userMenuOpen = false"
                    ...
                    <div class="px-4 py-2 border-b border-outline-variant/10 mb-1">
                        <p class="text-sm font-bold font-headline text-on-surface truncate">{{ auth()->user()->name }}
                        </p>
