...
<section
    class="relative overflow-hidden bg-gradient-to-br from-primary to-primary-container rounded-2xl p-8 text-on-primary shadow-xl"
    ...
    <div class="relative z-10">
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div>
                <span
                    class="bg-secondary-container/20 text-secondary-fixed px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest mb-4 inline-block font-label">
        ...
        <div class="mt-8">
            ...
            <div class="h-4 w-full bg-on-primary/10 rounded-full overflow-hidden backdrop-blur-md" role="progressbar"
                aria-valuenow="{{ $progress }}" aria-valuemin="0" aria-valuemax="100"
                aria-label="XP progress to next level">
                <div class="h-full bg-gradient-to-r from-secondary-fixed to-secondary-container rounded-full shadow-[0_0_15px_rgba(111,251,190,0.4)] transition-all duration-700"
    ...
    <div class="absolute -right-16 -top-16 w-64 h-64 bg-secondary-fixed/10 rounded-full blur-3xl" aria-hidden="true">
    </div>
    <div class="absolute -left-16 -bottom-16 w-48 h-48 bg-tertiary-fixed/10 rounded-full blur-2xl" aria-hidden="true">
    </div>
    <span
        class="material-symbols-outlined absolute right-8 top-1/2 -translate-y-1/2 text-[180px] opacity-5 pointer-events-none select-none"
