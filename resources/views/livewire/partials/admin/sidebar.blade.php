...
<aside x-data="{ sidebarOpen: false }"
       ...
       class="h-screen w-64 fixed left-0 top-0 bg-slate-50 border-r border-slate-200 z-50 flex-shrink-0 transition-transform duration-300 transform md:translate-x-0"
