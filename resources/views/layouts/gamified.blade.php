...
<body class="font-sans antialiased bg-background text-on-surface" x-data="{ sidebarOpen: false }">
    ...
    {{-- ── SIDEBAR ──────────────────────────────────────────────────── --}}
    <aside
        class="fixed left-0 top-20 flex flex-col h-[calc(100vh-5rem)] p-4 bg-slate-50 w-64 font-label z-40 transition-transform duration-300 transform md:translate-x-0"
        :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'"
        @toggle-sidebar.window="sidebarOpen = !sidebarOpen" @click.away="sidebarOpen = false"
    ...
    <div class="fixed top-0 right-0 -z-10 opacity-30 pointer-events-none" aria-hidden="true">
        <svg fill="none" height="600" viewBox="0 0 600 600" width="600" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="gamified_bg_gradient" x1="450" x2="450" y1="0"
                    y2="300">
